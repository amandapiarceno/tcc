...
\begin{document}
    ...
    \instituicao{Departamento de Matemática \par Centro de Ciênias Físicas e Matemáticas \par Universidade Federal De Santa Catarina}
    \local{Florianópolis - SC, Brasil}
    \data{04 de desembro 2015}
...
%\chapter*{Introdução}
	...
	%Neste sentido, para ter acesso à educação, por meio da Língua Brasileira de Sinais, em uma escola regular, necessita-se de um profissional 
	...
	%Pensando a prática docente, surgiu a motivação e a escolha do tema, A Educação Matemática no ensino de elunos surdos – A Importância do estudo de LIBRAS no curso de matemática licenciatura.
	...
	%Atualmente, há surdos que frequentam instituições escolares com enfoque oral, há os que frequentam instituições escolares que fazem uso da língua de sinais, os que nunca tiveram acesso à escola e os que fazem parte de “movimentos de surdos” que lutam pelos seus direitos linguísticos. Há, ainda, os que falam o português oral e se adaptam a tal forma de comunicação, porém, não há um grupo homogêneo. 	
	...
	%maior a respeito da verdadeira \textit{Educação de Surdos}. Assim, o trabalho a seguir tomou forma, através de pesquisa bibliográfica, pode-se estudar: \textit{O Educando surdo}, a \textit{Política 
	%Nacional de Inclusão}, \textit{O ensino/aprendizagem de Matemática}, \textit{O ensino/aprendizagem de/para alunos surdos} e a \textit{História da educação de surdos}.
