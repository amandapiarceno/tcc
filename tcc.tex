...
\begin{resumo}
	...
	educação  de surdos,  investigar como se constituiu ao longo do tempo a educação de alunos surdos no Brasil, as filosofias educacionais pensadas ao longo dos séculos na educação de 
	alunos surdos e defender o papel do aluno surdo em uma sala de aula onde a maioria dos alunos é ouvinte. Por fim, o presente trabalho tem como objetivo apontar, a partir de pesquisas bibliográficas, qual a melhor abordagem para ensinar matemática a um estudante surdo.   
...
\chapter*{Introdução}
	...
	Conforme a lei nº 9.394, de 20 dezembro de 1996, a educação escolar deve abranger os processos formativos vinculadas à prática social e ao mundo do trabalho. E ainda, o ensino destes alunos devem seguir 
	os princípios de: igualdade de condições para o acesso e a permanência na escola; liberdade de aprender, ensinar, pesquisar e divulgar a cultura, o pensamento, a arte e o saber; pluralismo de 
	ideias e de concepções pedagógicas; respeito à liberdade e apreço a tolerância; coexistência de instituições públicas e privadas de ensino; gratuidade do ensino público em estabelecimentos oficiais; 
	valorização do profissional da educação escolar; garantia de padrão de qualidade; valorização da experiência extra-escolar; vinculação entre a educação escolar, o trabalho e 
	...
	Neste sentido, para um aluno surdo ter acesso à educação em uma escola inclusiva da rede regular de ensino, faz-se necessário um profissional que 
	traduza e interprete - tradutor/intérprete - os conhecimentos que estão sendo proporcionados nesse ambiente para este aluno surdo, através da língua de sinais.
	...
	pelo método combinado (linguagem oral e língua de sinais). Como consta em documento produzido pelo MEC - \textit{Saberes e práticas da inclusão: desenvolvendo competências para o atendimento às 
	...
	matemática para alunos surdos. Teóricos como Peixoto (2013), Cruz e Lautert (2014), Sales (2013) e Leite (2007) irão, dentre outros autores, subsidiar essa pesquisa, pois destacam em suas obras aspectos que dizem 
	respeito à educação dos surdos; a relação dos surdos com os ouvintes nos ambientes escolares, conceitos como diferença e deficiência, maioria e minoria, linguagem oral e língua escrita; a importância do uso da língua de sinais na construção da identidade surda, constituindo assim a comunidade
	...
	surdez. O objetivo desta pesquisa se deu através da seguinte problematização: Qual a melhor abordagem, nos dias atuais, para ensinar matemática a um estudante surdo numa sala de aula inclusiva?  
	...
	de 2012, onde pude ter contato direto com pessoas surdas, os quais eram professores desta disciplina, e a dificuldade que enfrentei em me comunicar com estes professores surdos. 
	...
	tempos, bem como a luta dos surdos pelo reconhecimento da sua modalidade de comunicação, e ainda, refletir o trabalho educativo nos diferentes campos do conhecimento de forma a avaliar a prática 
	...
	\textit{Filosofias educacionais} - neste a finalidade é a de mostrar de forma detalhada as filosofias de ensino já vivenciadas por surdos no decorrer dos séculos, para isto, serão analisadas as abordagens \textit{Oralista}, 
	\textit{Comunicação Total} e \textit{Bilinguismo}. A \textit{Educação Bilíngue} - tem a finalidade de mostrar como é a proposta bilíngue na educação de alunos com surdez. \textit{O ensino e a aprendizagem de Matemática} - tem como objetivo trazer a reflexão a respeito da prática docente no ensino de matemática. Ainda, tem como finalidade o esclarecimento, através de apontamentos bibliográficos, de possíveis
	dúvidas com relação a capacidade de alunos surdos em compreender, bem como apresentar habilidades ou não, na disciplina de matemática.  
...
\chapter{Política Nacional de Inclusão}
	...
	\footnote{A educação inclusiva se constitui da diversidade dos indivíduos, buscando perceber e atender as necessidades de todos os estudantes, em salas de aulas comuns, em um sistema inclusivo de 
	ensino, de forma a promover a aprendizagem e o desenvolvimento social de todos.}
...
\chapter*{Conclusão}  
	...
	através da aquisição da linguagem oral. Assim, a escola e todas as filosofias educacionais para estudantes surdos partiam da ideia de que as pessoas surdas deveriam ser oralizadas para ter sucesso no seu 
	desenvolvimento cognitivo.  
	
	O presente trabalho conclui que o sujeito surdo tem sua identidade preservada através da sua forma de comunicação, ou seja, a partir da língua de sinais. Assim, a educação dentro da perspectiva da \textit{Política Nacional de Inclusão} de alunos surdos deve ser pensada, pelo professor, de forma a contemplar a língua de sinais e a língua portuguesa, considerando a forma de comunicação entre o aluno surdo e as demais pessoas a língua de sinais e a língua portuguesa como a forma escrita. 
	
	Atualmente, a política adotada no ensino de alunos surdos é a de inclusão. Desta forma, o processo de ensino deve ser trabalhado de maneira a alcançar todos os alunos, incluindo o aluno surdo. Assim, o professor deve buscar formas de ensino que forneçam requisitos suficientes para o aprendizado de alunos com surdez. 
	
	O ensino de matemática deve despertar no aluno o raciocínio lógico e argumentativo na resolução de problemas. Com o aluno surdo não deve ser diferente, visto que ele pode ter habilidade ou não com a matemática o professor deve fornecer ferramentas que subsidiem o ensino e a aprendizagem necessária para este aluno, assim como para os demais. 
  
	O professor deve estar atento as produções dos alunos, na forma com que eles elaboram suas estratégias resolutivas, seus
	esquemas, para poder entender quais as dificuldades ou habilidades que seus alunos apontam. E ainda, buscar compreender que o aluno precisa captar o que está acontecendo na aula através do intérprete. Assim, o professor deve ser cuidadoso com suas ações pois, enquanto os demais alunos ouvem e visualizam o que está sendo posto, o aluno surdo tem que entender o que o intérprete traduz e ver o que o professor está mostrando.   
	
	Entre todos os conhecimentos adquiridos ao longo deste trabalho, talvez o mias importante seja a constatação de que um estudante surdo possui, intelectualmente,
	as mesmas capacidades apresentadas por um ouvinte. Uma vez aceito com clareza, este fato pode mudar completamente a forma como um professor motivado é capaz
	de transmitir conhecimento a este aluno, transformando seu aprendizado em algo muito mais natural e proveitoso.
	
	Por fim, respondendo ao questionamento levantado pela problematização motivadora deste trabalho, conclui-se que o  bilinguismo é considerada, pelos estudiosos, 
	a abordagem educacional mais adequada, atualmente, para o ensino de alunos com surdez em uma sala de aula de uma escola inclusiva.
